...
<body>
    ...
    <div class="top-menu-bar">
        <div class="top-menu-content">
            <a href="#" class="ephemera-link">Ephemera</a> <input type="text" class="search-input" placeholder="Enter at least 3 characters to search..." id="searchInput">
    ...
    <div class="container">
        ...
        <div id="welcomeMessage">
            <h1>Ephemera 1.0.6</h1>
             ...
             <br><br>
<div align="left">
            <li><u><a href="rank_file.php">rank_file.php</a></u> : More clicked files</li><br>
            <li><a href="files.php">files.php</a> : List all files</li><br>
            <li><a href="index_default.php">index_default.php</a> : Default theme</li> 
 </div>
